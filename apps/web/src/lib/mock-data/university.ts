...
export const courseOfferings: CourseOffering[] = [
  {
    ...
    department: "Computer Science",
    teacherId: "t-01",
    teacherRecordId: "t-01",
    teacherName: "Dr. Meera Khanna",
    sectionId: "sec-btech-cse-4a",
    sectionRecordId: "sec-btech-cse-4a",
    sectionName: "B.Tech CSE 4A",
    dayCode: "MON",
    startTime: "09:00",
    endTime: "10:00",
    requiredCapacity: 58,
  ...
  },
  {
    ...
    department: "Computer Science",
    teacherId: "t-02",
    teacherRecordId: "t-02",
    teacherName: "Prof. Arjun Nair",
    sectionId: "sec-btech-cse-6b",
    sectionRecordId: "sec-btech-cse-6b",
    sectionName: "B.Tech CSE 6B",
    dayCode: "TUE",
    startTime: "11:00",
    endTime: "13:00",
    requiredCapacity: 42,
